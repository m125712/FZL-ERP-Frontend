...
export default function Index() {
	const info = new PageInfo(
		"RM Dyeing And Iron Log",
		"material/used/by/dying_and_iron"
	);
	...
	const handelUpdate = (idx) => {
		const selected = dyeingAndIron[idx];
	...
	const handelDelete = (idx) => {
		setDeleteItem((prev) => ({
			...prev,
			itemId: dyeingAndIron[idx].id,
			itemName: dyeingAndIron[idx].material_name
				.replace(/#/g, "")
				.replace(/\//g, "-"),
		}));
