...
export default function Index() {
	...
	const { data, isLoading, url, deleteData } =
		useMaterialSection('maintenance');
	const info = new PageInfo(
		'Store (Maintenance) / Material Section',
		url,
		'store_maintenance__section'
	);
	const haveAccessRm = useAccess('store_maintenance__section');
	const haveAccessAccessor = useAccess('store_maintenance__section');
