...
const SectionContainer = ({ title, children, className, buttons }) => {
	return (
		<div className={cn('', className)}>
			<div className='flex items-center gap-2 rounded-t-md bg-secondary px-4 py-3 text-2xl font-semibold capitalize leading-tight text-secondary-content md:text-3xl'>
				{title}
