const getTransactionArea = () => {
	return [
		{ label: 'Box Pin (Metal section)', value: 'box_pin_metal' },
		{ label: 'Chemicals - Dyeing', value: 'chemicals_dyeing' },
		{ label: 'Chemicals:Coating', value: 'chemicals_coating' },
		{
			label: 'Coating Section:Epoxy Paint (Harmes)',
			value: 'coating_epoxy_paint_harmes',
		},
		{ label: 'Coil Forming/Sewing', value: 'coil_forming_sewing' },
		{
			label: 'Coil Forming/Sewing Forming',
			value: 'coil_forming_sewing_forming',
		},
		{ label: 'Die Casting Section', value: 'die_casting' },
		{ label: 'Dyeing Section', value: 'dyeing' },
		...
		{ label: 'Invisible section', value: 'invisible' },
		{ label: 'Metal Finishing Section', value: 'metal_finishing' },
		{ label: 'Metal Section', value: 'metal' },
		{
			label: 'Metal Teeth Electroplating',
			value: 'metal_teeth_electroplating',
		},
		{ label: 'Metal Teeth Molding Section', value: 'metal_teeth_molding' },
		{ label: 'Metal Teeth Plating Section', value: 'metal_teeth_plating' },
		{ label: 'Nylon', value: 'nylon' },
		{ label: 'Nylon Finishing Section', value: 'nylon_finishing' },
		...
		{ label: 'Sewing Thread Finishing', value: 'sewing_thread_finishing' },
		{ label: 'Sewing Thread Section', value: 'sewing_thread' },
		{ label: 'Slider Assembly Section', value: 'slider_assembly' }, //* can not delete
		{
		...
		{ label: 'Soft Winding', value: 'soft_winding' },
		...
		{ label: 'Zipper Dying', value: 'zipper_dying' },
	];
};
