...
export default function Index({
	...
	const { user } = useAuth();
	// v_gapping v_teeth_cleaning v_sealing v_t_cutting v_stopper
	const MAX_QUANTITY =
		(updateFinishingLog?.section === "v_gapping"
			? updateFinishingLog?.v_gapping
			: updateFinishingLog?.section === "v_teeth_cleaning"
				? updateFinishingLog?.v_teeth_cleaning
				: updateFinishingLog?.section === "v_sealing"
					? updateFinishingLog?.v_sealing
					: updateFinishingLog?.section === "v_t_cutting"
						? updateFinishingLog?.v_t_cutting
						: updateFinishingLog?.v_stopper) +
