...
const AgainstIssue = lazy(() => import('./AgainstIssue'));
...
export default function Index({ type, accessor }) {
	...
	const columns = useMemo(
		() => [
			...
			},
			{
				accessorKey:
					type === 'maintenance'
						? 'action_trx_against_issue'
						: 'action_trx_against_order',
				header:
					type === 'maintenance'
						? 'Trx Against Issue'
						: 'Trx Against Order',
	...
	const handleTrxAgainstOrder = (idx) => {
		...
		window[
			type === 'maintenance'
				? 'MaterialTrxAgainstIssue'
				: 'MaterialTrxAgainstOrder'
		].showModal();
	};
	...
	return (
		<div>
			...
			<Suspense>
				...
				/>
				<AgainstIssue
					modalId={'MaterialTrxAgainstIssue'}
					updateMaterialDetails={updateMaterialDetails}
					setUpdateMaterialDetails={setUpdateMaterialDetails}
				/>
				<AddOrUpdateBooking
