...
import { useDailyChallanDR } from '@/state/Report';
...
export default function Index() {
	const haveAccess = useAccess('report__daily_challan_dr');
	const { user } = useAuth();

	const [date, setDate] = useState(new Date());
	const [toDate, setToDate] = useState(new Date());

	const { data, isLoading, url } = useDailyChallanDR(
	...
	const info = new PageInfo('Daily Challan', url, 'report__daily_challan_dr');
