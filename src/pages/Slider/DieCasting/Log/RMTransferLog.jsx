...
export default function Index() {
	const info = new PageInfo(
		"RM Die Casting Log",
		"material/used/by/die_casting"
	);
	const [dieCasting, setDieCasting] = useState([]);
	const [loading, setLoading] = useState(true);
	const [error, setError] = useState(null);
	const haveAccess = useAccess("slider__die_casting_log");
	...
	const handelDelete = (idx) => {
		setDeleteItem((prev) => ({
			...prev,
			itemId: dieCasting[idx].id,
			itemName: dieCasting[idx].material_name
				.replace(/#/g, "")
				.replace(/\//g, "-"),
		}));
	...
	useEffect(() => {
		useFetchFunc(info.getFetchUrl(), setDieCasting, setLoading, setError);
	}, []);
