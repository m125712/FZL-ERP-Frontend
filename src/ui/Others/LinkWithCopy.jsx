...
const BaseBody = ({ value, to, showCopyButton = true }) => {
	...
	return (
		<button
			type='button'
			className='flex items-center gap-2 text-left font-semibold underline underline-offset-2 transition-colors duration-300 hover:text-info hover:decoration-info'
		>
