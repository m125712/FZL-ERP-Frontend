...
import { useOrderSheetSRZipper } from '@/state/Report';
...
export default function Index() {
	...
	const { data, isLoading, updateData } = useOrderSheetSRZipper(
	...
	const handelSwatch = async (idx) => {
		await updateData.mutateAsync({
			url: `/zipper/order-info/swatch-attachment/update/by/${data[idx]?.order_info_uuid}`,
			updatedData: {
	...
	return (
		<ReactTable
			showDateRange={false}
			title={'Order Sheet Send & Receive (Zipper)'}
			accessor={false}
			data={data}
			columns={columns}
			extraButton={
