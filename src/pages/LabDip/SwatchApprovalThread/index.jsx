...
import { useDyeingDummy, useSwatchApprovalThread } from '@/state/Dyeing';
...
export default function Index() {
	...
	const { data, isLoading, updateData } = useSwatchApprovalThread(
	...
	const info = new PageInfo(
		...
		'/lab-dip/swatch-approval-thread',
		'lab_dip__swatch_approval_thread'
	);
	const haveAccess = useAccess('lab_dip__swatch_approval_thread');

	const handleSwatchApprovalDate = async (idx) => {
		await updateData.mutateAsync({
			url: `/thread/swatch-approval-received/${data[idx]?.uuid}`,
			updatedData: {
