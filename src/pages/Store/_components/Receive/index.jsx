...
export default function Index({ type, accessor }) {
	...
	const { data, isLoading, deleteData } = usePurchaseDescription(type);

	const info = new PageInfo(
		`Store (${type.toUpperCase()}) / Material Receive`,
		`/store-${type}/receive`,
		accessor
	);
	...
	// Add
	const handelAdd = () => navigate(`/store-${type}/receive/entry`);

	const handelUpdate = (idx) => {
		navigate(`/store-${type}/receive/${data[idx].uuid}/update`);
	};
