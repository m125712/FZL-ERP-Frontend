...
export default function InfoCard({ title, notapproved, approved }) {
	return (
		<div className="flex flex-col flex-wrap rounded-md bg-primary shadow-md">
			<div className="rounded-t-md  py-1 text-center text-primary-content">
				{title}
			</div>
			<div className="flex items-center justify-around gap-4 rounded-md bg-secondary px-2.5 py-2">
